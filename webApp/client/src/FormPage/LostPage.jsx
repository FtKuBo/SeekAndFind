...
function LostPage() {
    ...
    useEffect(() => {
        if (userInputted){
            sendLostRequest(description, objectType, location, date, brand)
            .then(data => {
                if (data.objectDescription === description){
                    sendLostRequestToMatchingSys(description, objectType, location, date, brand)
                    .then(() => {
    ...
    const sendLostRequest = async (descrp, objType, objLoc, dt, objBrand) => {
        return axios({
            method: 'post',
    ...
    const sendLostRequestToMatchingSys = async (descrp, objType, objLoc, dt, objBrand) => {
        return axios({
            method: 'post',
            url: `${backendUrl}/broker/sendMessage?topic=object/lost`,
            headers: {}, 
            data: {
            userEmail: email,
            objectDescription:descrp,
    ...
    return (
        <div className="form-container">
            ...
            <h1 className="form-title">Lost an Electronic Object</h1>
